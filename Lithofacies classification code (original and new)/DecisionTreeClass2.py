...
#读取数据并将数据转换为array格式
data_files = []
data_files = pd.read_csv("C:/Users/Administrator.DESKTOP-G2KEBOV/Desktop/岩相分类数据/333.csv")
data_files2 = pd.read_csv("C:/Users/Administrator.DESKTOP-G2KEBOV/Desktop/岩相分类数据/334.csv")
#设定为函数
...
param_grid = {"max_depth":[i for i in range(2, 50)]
              }

GS_model = GridSearchCV(estimator, param_grid, scoring='accuracy', cv=10 ,verbose=1 ,n_jobs=-1)
