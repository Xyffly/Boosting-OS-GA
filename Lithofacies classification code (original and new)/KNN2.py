...
# "num_leaves": [i for i in range(2, 10)],
param_grid = {"weights": ["uniform"],
              "n_neighbors": [i for i in range(1, 20)],
              "p": [1 for i in range(1, 20)]}
clf_random = GridSearchCV(estimator, param_grid, scoring='accuracy', cv=10, n_jobs=-1, verbose=1)
...
print("真实结果",Y_test)
print("预测结果",Y_pred)
random = clf_random.best_estimator_
